...
export function PaymentInitiation() {
  ...
  const handlePayment = () => {
    ...
    alert(`Payment initiated: RWF ${amount} via ${activeMethod.toUpperCase()}`);
  };
  ...
  return (
    <div className="bg-white dark:bg-[#1a1a1a] rounded-2xl shadow-xl dark:shadow-lime-500/5 p-6 md:p-8 border border-transparent dark:border-gray-800">
      <div className="mb-6">
        <h3 className="text-2xl font-bold text-gray-900 dark:text-lime-400 mb-2">Payment Initiation</h3>
          ...
          <div>
            ...
            <div className="mb-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button className="flex items-center gap-3 p-4 border-2 border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 rounded-lg hover:border-lime-500 dark:hover:border-lime-400 hover:bg-lime-50 dark:hover:bg-lime-900/10 transition">
            ...
            <button
              ...
              className="w-full py-3 kp-gradient-soft text-white rounded-lg font-medium hover:shadow-lg kp-hover-lift transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              Initiate Payment
          ...
          <div>
            <div className="kp-gradient-subtle rounded-xl p-6 mb-4 border border-white/20 shadow-lg">
              ...
              <div className="bg-white dark:bg-gray-900 rounded-lg p-4 mb-4 border border-gray-200 dark:border-gray-700">
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-mono font-bold text-gray-900 dark:text-white" style={{ color: 'var(--kp-green-dark)' }}>{ussdCode}</span>
                  <button
              ...
              <p className="text-sm text-white/90 text-center">
                Dial this code from your mobile phone to access KASI PAY services
              </p>
            </div>

            <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 mb-4 border border-gray-200 dark:border-gray-800">
              <h4 className="font-medium text-gray-900 dark:text-white mb-3">USSD Menu Options:</h4>
            ...
            <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
              <p className="text-sm text-yellow-800 dark:text-yellow-300">
                <strong>Note:</strong> USSD works on all phones, including feature phones.
      ...
      <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-800">
        <div className="flex items-center justify-center gap-2 text-sm text-gray-500 dark:text-gray-400">
          ...
          <span>Secure payment powered by KASI PAY</span>
        </div>
      </div>
    </div>
  );
