                ...
                {history.map((payment) => (
                  <tr key={payment.id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-4 px-4">
                      ...
                      {payment.provider && (
                        <p className="text-xs text-gray-500 uppercase">{payment.provider}</p>
                      )}
                    </td>
                    <td className="py-4 px-4">
                      <p className="font-semibold text-gray-900">RWF {Math.abs(payment.amount).toLocaleString()}</p>
                    </td>
                    <td className="py-4 px-4">
                      <span className="text-sm text-gray-600">{METHOD_LABEL[payment.method] ?? payment.method}</span>
                    </td>
                    <td className="py-4 px-4">
                      <span className="text-sm text-gray-600">{new Date(payment.created_at).toLocaleString()}</span>
                    </td>
                    <td className="py-4 px-4">
